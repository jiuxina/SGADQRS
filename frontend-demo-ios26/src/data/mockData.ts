...
export interface User {
  ...
  deptName: string; phone: string; email: string; status: 'active' | 'disabled'
  lastLogin: string; createTime: string
}

export const mockUsers: User[] = [
  { id: '1', username: '2021010101', realName: '张明辉', userType: 'student', deptName: '计算机科学与技术学院', phone: '138****1234', email: 'zhangmh@edu.cn', status: 'active', lastLogin: '2025-06-10 14:30', createTime: '2021-09-01' },
  { id: '2', username: '2021010102', realName: '李思雨', userType: 'student', deptName: '计算机科学与技术学院', phone: '139****5678', email: 'lisy@edu.cn', status: 'active', lastLogin: '2025-06-10 12:15', createTime: '2021-09-01' },
  { id: '3', username: '2021010103', realName: '王浩然', userType: 'student', deptName: '计算机科学与技术学院', phone: '136****9012', email: 'wanghr@edu.cn', status: 'active', lastLogin: '2025-06-09 16:40', createTime: '2021-09-01' },
  { id: '4', username: '2021010201', realName: '陈佳琪', userType: 'student', deptName: '软件工程学院', phone: '137****3456', email: 'chenjq@edu.cn', status: 'active', lastLogin: '2025-06-10 09:00', createTime: '2021-09-01' },
  { id: '5', username: '2021010202', realName: '刘子轩', userType: 'student', deptName: '软件工程学院', phone: '135****7890', email: 'liuzx@edu.cn', status: 'disabled', lastLogin: '2025-05-20 11:30', createTime: '2021-09-01' },
  { id: '6', username: 'T001', realName: '王建国', userType: 'teacher', deptName: '计算机科学与技术学院', phone: '138****0001', email: 'wangjg@edu.cn', status: 'active', lastLogin: '2025-06-10 08:30', createTime: '2015-07-01' },
  { id: '7', username: 'T002', realName: '李明华', userType: 'teacher', deptName: '软件工程学院', phone: '139****0002', email: 'limh@edu.cn', status: 'active', lastLogin: '2025-06-09 17:20', createTime: '2016-03-15' },
  { id: '8', username: 'T003', realName: '张伟', userType: 'teacher', deptName: '信息安全学院', phone: '136****0003', email: 'zhangw@edu.cn', status: 'active', lastLogin: '2025-06-08 14:10', createTime: '2017-09-01' },
  { id: '9', username: 'T004', realName: '陈静', userType: 'teacher', deptName: '数据科学学院', phone: '137****0004', email: 'chenj@edu.cn', status: 'disabled', lastLogin: '2025-04-15 10:00', createTime: '2018-03-01' },
  { id: '10', username: 'admin', realName: '系统管理员', userType: 'admin', deptName: '教务处', phone: '138****0000', email: 'admin@edu.cn', status: 'active', lastLogin: '2025-06-10 15:00', createTime: '2020-01-01' },
  { id: '11', username: '2021010301', realName: '孙博文', userType: 'student', deptName: '信息安全学院', phone: '159****6789', email: 'sunbw@edu.cn', status: 'active', lastLogin: '2025-06-10 11:45', createTime: '2021-09-01' },
  { id: '12', username: '2021010302', realName: '周晓敏', userType: 'student', deptName: '信息安全学院', phone: '186****0123', email: 'zhouxm@edu.cn', status: 'active', lastLogin: '2025-06-09 15:20', createTime: '2021-09-01' },
]
