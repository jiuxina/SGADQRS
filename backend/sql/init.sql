...
-- 默认账号密码统一为 123456
-- BCrypt加密
INSERT INTO `sys_user` VALUES (1, 'admin', '$2b$10$j7XnMEsPsByfvmbAQqFmLORnxpqfL/QrrRccVMsHN.izBV6n1jyRG', '系统管理员', NULL, 1, 3, NULL, NULL, NULL, 1, NOW(), NOW(), NOW());

-- 教师账号（密码: 123456）
INSERT INTO `sys_user` VALUES (2, 'T2024001', '$2b$10$j7XnMEsPsByfvmbAQqFmLORnxpqfL/QrrRccVMsHN.izBV6n1jyRG', '张教授', NULL, 1, 2, 1, NULL, NULL, 1, NOW(), NOW(), NOW());
INSERT INTO `sys_user` VALUES (3, 'T2024002', '$2b$10$j7XnMEsPsByfvmbAQqFmLORnxpqfL/QrrRccVMsHN.izBV6n1jyRG', '李副教授', NULL, 2, 2, 1, NULL, NULL, 1, NOW(), NOW(), NOW());

-- 学生账号（密码: 123456）
INSERT INTO `sys_user` VALUES (4, 'S20210001', '$2b$10$j7XnMEsPsByfvmbAQqFmLORnxpqfL/QrrRccVMsHN.izBV6n1jyRG', '王明', NULL, 1, 1, 1, 1, 1, 1, NOW(), NOW(), NOW());
INSERT INTO `sys_user` VALUES (5, 'S20210002', '$2b$10$j7XnMEsPsByfvmbAQqFmLORnxpqfL/QrrRccVMsHN.izBV6n1jyRG', '李华', NULL, 2, 1, 1, 1, 1, 1, NOW(), NOW(), NOW());
INSERT INTO `sys_user` VALUES (6, 'S20210003', '$2b$10$j7XnMEsPsByfvmbAQqFmLORnxpqfL/QrrRccVMsHN.izBV6n1jyRG', '赵强', NULL, 1, 1, 1, 2, 2, 1, NOW(), NOW(), NOW());
INSERT INTO `sys_user` VALUES (7, 'S20220001', '$2b$10$j7XnMEsPsByfvmbAQqFmLORnxpqfL/QrrRccVMsHN.izBV6n1jyRG', '陈静', NULL, 2, 1, 1, 1, 1, 1, NOW(), NOW(), NOW());
INSERT INTO `sys_user` VALUES (8, 'S20220002', '$2b$10$j7XnMEsPsByfvmbAQqFmLORnxpqfL/QrrRccVMsHN.izBV6n1jyRG', '刘洋', NULL, 1, 1, 2, 3, 3, 1, NOW(), NOW(), NOW());
...
-- 竞赛数据
INSERT INTO `competition` VALUES (1, '全国大学生数学建模竞赛', '教育部高等教育司', 2, NULL, '全国大学生数学建模竞赛是国内规模最大的基础性学科竞赛，创办于1992年，每年一届。', '1. 每队3人；2. 赛期3天；3. 提交论文', '2026-05-01 00:00:00', '2026-06-30 23:59:59', '2026-09-10 00:00:00', '2026-09-13 00:00:00', '线上+线下', 3, 100, '[{"name":"一等奖","level":1},{"name":"二等奖","level":2},{"name":"三等奖","level":3}]', 2, NOW(), NOW());
INSERT INTO `competition` VALUES (2, 'ACM-ICPC程序设计竞赛', '国际计算机学会', 2, NULL, 'ACM国际大学生程序设计竞赛是最具影响力的大学生程序设计竞赛。', '1. 每队3人；2. 5小时；3. C/C++/Java/Python', '2026-04-01 00:00:00', '2026-05-15 23:59:59', '2026-06-01 00:00:00', '2026-06-01 05:00:00', '计算机学院实验室', 3, 50, '[{"name":"金牌","level":1},{"name":"银牌","level":2},{"name":"铜牌","level":3}]', 2, NOW(), NOW());
INSERT INTO `competition` VALUES (3, '中国"互联网+"大学生创新创业大赛', '教育部', 3, NULL, '中国"互联网+"大学生创新创业大赛，由教育部与政府、各高校共同主办。', '1. 团队参赛；2. 提交商业计划书；3. 现场路演', '2026-03-01 00:00:00', '2026-04-30 23:59:59', '2026-07-01 00:00:00', '2026-07-03 00:00:00', '学校大礼堂', 5, 30, '[{"name":"金奖","level":1},{"name":"银奖","level":2},{"name":"铜奖","level":3},{"name":"最佳创意奖","level":4}]', 2, NOW(), NOW());
INSERT INTO `competition` VALUES (4, '全国大学生电子设计竞赛', '教育部高等教育司', 3, NULL, '全国大学生电子设计竞赛是面向大学生的群众性科技活动。', '1. 每队3人；2. 4天3夜；3. 完成实物制作', '2026-05-15 00:00:00', '2026-07-15 23:59:59', '2026-08-01 00:00:00', '2026-08-04 00:00:00', '电子信息学院实验室', 3, 40, '[{"name":"一等奖","level":1},{"name":"二等奖","level":2},{"name":"三等奖","level":3}]', 1, NOW(), NOW());
INSERT INTO `competition` VALUES (5, '校园英语演讲比赛', '外国语学院', 2, NULL, '提升大学生英语口语表达能力和跨文化交际能力。', '1. 个人赛；2. 3分钟定题演讲；3. 2分钟即兴', '2026-04-10 00:00:00', '2026-05-10 23:59:59', '2026-05-25 00:00:00', '2026-05-25 12:00:00', '外语学院报告厅', 1, 60, '[{"name":"一等奖","level":1},{"name":"二等奖","level":2},{"name":"三等奖","level":3},{"name":"最佳风采奖","level":4}]', 2, NOW(), NOW());
INSERT INTO `competition` VALUES (6, '"蓝桥杯"软件设计大赛', '工业和信息化部', 2, NULL, '蓝桥杯全国软件和信息技术专业人才大赛。', '1. 个人赛；2. 4小时；3. C/C++/Java', '2026-02-01 00:00:00', '2026-03-31 23:59:59', '2026-04-15 00:00:00', '2026-04-15 16:00:00', '线上', 1, 200, '[{"name":"一等奖","level":1},{"name":"二等奖","level":2},{"name":"三等奖","level":3},{"name":"优秀奖","level":4}]', 4, NOW(), NOW());
